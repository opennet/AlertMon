...
@EXPORT = qw();
@EXPORT_OK = qw(cgi_load_param cgi_escape cgi_load_cookies cgi_load_cookie_name cgi_unescape cgi_check_security);
...
# Проверка переданных параметров на наличие "опасных" символов
sub cgi_check_security {
    my ( $val ) = $_[0]; 
    my ( $cmd ) = $_[1]; 
