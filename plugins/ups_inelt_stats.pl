...
#
# ups_inelt_stats.pl <L|F|C> <device> [<min_limit> <max_limit>]
...
###########################################################################
if (! defined $ARGV[1]){
    die "Usage: ups_inelt_stats.pl <L|F|C> <device> [<min_limit> <max_limit>]\n";
}
